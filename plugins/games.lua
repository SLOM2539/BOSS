...
if MsgText[1] == 'الالغاز' or MsgText[1] == 'لغز' then
  ...
  name = katu[math.random(#katu)]
  redis:set(boss..':Set_sjs:'..msg.chat_id_,name)
...
• الالغاز ⇠ لعبه اسئله صعبة ومسليه
...
• اغاني الطفوله ⇠ لعبة اغاني كرتون قديمة
• دين ⇠ لعبه اسئله دينيه
• الالغاز ⇠ لعبه اسئلة صعبة ومسليه
• علم الدول ⇠ لعبه اعلام دول
• عواصم ⇠ لعبة عواصم دول
• اسم مغني ⇠ لعبه معرفه اسماء المغنيين
• المختلف ⇠ لعبه اختلاف لسمايل
...
if msg.text == redis:get(boss..':Set_sjs:'..msg.chat_id_) then -- // الغاز
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(boss..':Set_sjs:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*•   كفو اجابتك صح   \n*   \n')
end
