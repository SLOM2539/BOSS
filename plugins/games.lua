...
if points == "0" then
return '• اعذرني ياعيني ماعندك مجوهرات \n• اذا ودك على المجوهرات العب احد الالعاب الموجوده في `قائمه الالعاب`'
else
