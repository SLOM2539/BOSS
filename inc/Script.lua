...
if MsgText[1] == "ضع كليشه السورس" or MsgText[1] == "ضع كليشه السورس 📬" then
...
‎{"ضع كليشه المطور 📬","ضع كليشه السورس 📬"},
‎{"اصدار السورس 🗃"},
‎{"نقل ملكيه البوت 📇"},
...
elseif Text:match("^"..Bot_Name.."نادي (.*)$") and msg.SudoUser then
if msg.reply_id then
sendMsg(msg.chat_id_,msg.id_,'ابشر من عيوني')
sendMsg(msg.chat_id_,msg.reply_id,'يالحبيب تعال يبونك') 
else
end
elseif Text:match("^"..Bot_Name.."اتفل (.*)$") then
if msg.reply_id then
sendMsg(msg.chat_id_,msg.id_,'ابشر ياشيخ')
sendMsg(msg.chat_id_,msg.reply_id,'تفوو عليك ياغبي')
else 
