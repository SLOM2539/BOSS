...
if not msg.SudoUser then return '*⇜* انت مو المطور 'end
...
return sendMsg(arg.ChatID,arg.MsgID,"*⇜* هييه مايمديك تقييد مطور السورس!\n") 
...
elseif UserID == "1619524486" or UserID == "1619524486" then 
return sendMsg(msg.chat_id_,msg.id_,"*⇜* هييه مايمديك تقييد مطور السورس! \n") 
...
if UserID == 1619524486 or UserID == 1619524486 then return sendMsg(msg.chat_id_,msg.id_,"*⇜* مايمديك تنزل مطور السورس \n") end
...
if MsgText[1] == 'رفع نسخه للمجموعات' then
if not msg.SudoBase then return "⇜ هذا الامر يخص ( المطور الاساسي ) بس  \n" end
if msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg, data)
...
function tophoto(kara,ksab)    
if ksab.content_.ID == "MessageSticker" then         
local bd = ksab.content_.sticker_.sticker_.path_           
