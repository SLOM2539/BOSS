...
if MsgText[1]== "قناه السورس" and msg.type == "pv" then
local inline = {{{text="قـنـاة سـورس",url="https://t.me/kkrck"}}}
...
if msg.text=="اوامر الحقوق" then 
if msg.SudoBase then
local text = '• اهلين يالمطور في قسم اوامر الحقوق'
local keyboard = {
‎{"ضع صوره للترحيب"},
‎{"ضع اسم للبوت"},
‎{"وضع كليشه المطور"},
...
if msg.text=="اوامر الاذاعه" then 
if msg.SudoBase then
local text = '• اهلين يالمطور في قسم اوامر الاذاعه'
local keyboard = {
‎{"اذاعه بالتثبيت"},
‎{"اذاعه عام"},
‎{"اذاعه"},
...
if msg.text=="اوامر الردود" then 
if msg.SudoBase then
local text = '• اهلين يالمطور في قسم اوامر الردود'
local keyboard = {
‎{"اضف رد عام"},
‎{"مسح رد عام"},
‎{"الردود العامه"},
...
if msg.text=="اوامر التنظيف" then 
if msg.SudoBase then
local text = '• اهلين يالمطور في قسم اوامر التنظيف'
local keyboard = {
‎{"تنظيف المشتركين"},
‎{"تنظيف المجموعات"},
‎{"العوده"},
...
if msg.text=="اوامر التفعيل" then 
if msg.SudoBase then
local text = '• اهلين يالمطور في قسم اوامر التفعيل'
local keyboard = {
‎{"تفعيل التواصل"},
...
if msg.text=="اوامر التعطيل" then 
if msg.SudoBase then
local text = '• اهلين يالمطور في قسم اوامر التعطيل'
local keyboard = {
‎{"تعطيل التواصل"},
...
if msg.text=="اوامر التعيين" then 
if msg.SudoBase then
local text = '• اهلين يالمطور في قسم اوامر التعيين'
local keyboard = {
‎{"تعيين كليشه الستارت"},
‎{"تعيين كليشه الايدي العام"},
‎{"العوده"},
‎{"الغاء الامر ✖️"}}
return send_key(msg.sender_user_id_,text,keyboard,nil,msg.id_)
end
...
local keyboard = {
‎{"اوامر الحقوق","اوامر الاذاعه"},
‎{"اوامر الردود","اوامر التنظيف"},
‎{"اوامر التفعيل","اوامر التعطيل"},
‎{"اوامر التعيين"},
‎{"الاحصائيات","تغيير الاشتراك الاجباري"},
‎{"اصدار السورس","تحديث السورس"},
‎{"نقل ملكيه البوت","نسخه احتياطيه للمجموعات"},
‎{"قائمه المجموعات","المجموعات","قناه السورس"},
‎{"ايدي","تحديث","الاشتراك الاجباري","المطورين"},
‎{"مسح كليشه الستارت","مسح كليشه الايدي العام"},
‎{"مسح قائمه العام"},
‎{"الغاء الامر ✖️"}}
return send_key(msg.sender_user_id_,text,keyboard,nil,msg.id_)
else
...
if utf8.len(msg.text) > 500000 then 
return sendMsg(msg.chat_id_,msg.id_,"• معليش مو مسموح تضيف كلمة الرد باكثر من 500000 حرف \n")
end
...
if utf8.len(msg.text) > 500000 then 
return sendMsg(msg.chat_id_,msg.id_,"• معليش مو مسموح تضيف اكثر من 500000 حرف كلمة رد \n ")
end
...
if utf8.len(msg.text) > 500000 then 
return sendMsg(msg.chat_id_,msg.id_,"• معليش مو مسموح تضيف كلمه الرد باكثر من 500000 حرف \n")
end
