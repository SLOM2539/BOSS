...
if msg.text then
if msg.text == 'ملصق' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(boss..'kadmeat'..msg.chat_id_)   then
...
if msg.text == 'صوره' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(boss..'kadmeat'..msg.chat_id_)   then
if is_JoinChannel(msg) == false then
return false
end
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(arg,data)
...
if msg.text == 'بصمه' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(boss..'kadmeat'..msg.chat_id_)   then
if is_JoinChannel(msg) == false then
return false
end
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(arg,data)
...
if msg.text == 'صوت' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(boss..'kadmeat'..msg.chat_id_)   then
if is_JoinChannel(msg) == false then
return false
end
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(arg,data)
...
if msg.text == 'mp3' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(boss..'kadmeat'..msg.chat_id_)   then
if is_JoinChannel(msg) == false then
return false
end
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(arg,data)
...
if msg.text == 'متحركه' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(boss..'kadmeat'..msg.chat_id_)   then
if is_JoinChannel(msg) == false then
return false
end
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(arg,data)
