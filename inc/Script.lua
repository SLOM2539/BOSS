...
if MsgText[1] == 'تعيين قائمه الاوامر' or MsgText[1] == 'تعيين قائمه الاوامر ⚡️' then
...
if MsgText[1] == "الردود العشوائيه العامه" or MsgText[1] == "الردود العشوائيه العامه ©️" then
if not msg.SudoUser then return "• هذا الامر يخص ( المطور ) بس  \n" end
...
{"اضف رد عشوائي عام ➕","مسح رد عشوائي عام ➖","الردود العشوائيه العامه ©️"},
{"تحديث السورس ™️"},
{"الغاء الامر ✖️"}}
